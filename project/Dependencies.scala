...
object Dependencies {
  ...
  val akkaPertInMem = "com.github.dnvriend" %% "akka-persistence-inmemory" % "1.3.7" % Test

  val akStreamTestkit = "com.typesafe.akka" %% "akka-stream-testkit" % akkaVersion % Test
  val akHttpTestkit = "com.typesafe.akka" %% "akka-http-testkit" % akkaHttpVersion % Test
  ...
  val akkaPersistDeps = Seq(akkaActor, akkaPersistence, levelDB, levelDBjni, 
    akkaPertInMem, akStreamTestkit, akHttpTestkit)
}