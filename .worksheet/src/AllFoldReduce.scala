import java.io.File
object AllFoldReduce {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(86); 
  ...
  sumAcc(l, 0);System.out.println("""res0: Int = """ + $show(res$0));$skip(127); 
